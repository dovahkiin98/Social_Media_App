...
fun LoginUI(
    ...
    val emailFillNode = AutofillNode(
        autofillTypes = listOf(AutofillType.EmailAddress),
        onFill = { emailValue = it }
    )

    LocalAutofillTree.current += emailFillNode

    val passwordFillNode = AutofillNode(
        autofillTypes = listOf(AutofillType.Password),
        onFill = { passwordValue = it }
    )

    LocalAutofillTree.current += passwordFillNode
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                modifier = Modifier
                    ...
                    .onGloballyPositioned {
                        emailFillNode.boundingBox = it.boundsInWindow()
                    }
                    .onFocusChanged {
                        autofill?.run {
                            if (it.isFocused) {
            ...
            OutlinedTextField(
                ...
                modifier = Modifier
                    .fillMaxWidth()
                    .onGloballyPositioned {
                        passwordFillNode.boundingBox = it.boundsInWindow()
                    }
                    .onFocusChanged {
                        autofill?.run {
                            if (it.isFocused) {
